...
\examples{ex:route}
    ...
    {\translated 現在\route{内服}しているのは\drug{レトロゾール}です \translation{I am currently taking \drug{letrozole} \route{orally}.}} 
...
\examples{ex:url}
    ...
    {\madeup ここに詳しく載ってます \link{www．ｘｘｘ．ｘｘ}} 
...
Therefore, we include it in the annotations and draw a \texttt{caused} relation between the \dr and the withdrawal symptoms (\dis).
...
\examples{ex:refers}
    {\translated \drawRelations{I had \& \disorder{chills} \& and my \anatomy{whole body} was \& \disorder{shaking}}{
        \refersRel{4}{2}
    }}
