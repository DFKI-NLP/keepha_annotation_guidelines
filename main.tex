...
\begin{tabular}{@{}ll@{}}
\toprule
\textbf{entity}   & {\textbf{attributes}} \\ \midrule

\drug{\dr}                          & \texttt{increase}, \texttt{decrease}, \texttt{stopped}, \texttt{started}, \texttt{unique\_dose} \\
\disorder{\dis}                     & \\
\anatomy{\texttt{anatomy}}          & \\              
\test{\texttt{test}}                & \\          
\function{\texttt{function}}        & \\                
\eval{\texttt{evaluation / assessment}}    & \texttt{positive}, \texttt{negative}, \texttt{neutral} \\
\measure{\texttt{measure}}          & \\
\timex{\texttt{timex}}~             & \texttt{frequency}, \texttt{duration}, \texttt{date}, \texttt{point} \\
\route{\texttt{route}}              & \\
\trigger{\texttt{drug\ status change trigger}}  & \\
\user{\texttt{user}}                & \\
\link{\texttt{url}}                 & \\
\info{\texttt{personal information}}   & \\
\doctor{\texttt{doctor}}            & \\
\other{\texttt{other}}              & \\
