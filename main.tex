...
% \newcommand{\drugNeg}[1]{\colorbox{brass}{#1$_{\texttt{drug}}^{\textcolor{red}{negated}}$}}
...
% \newcommand{\triggerInc}[1]{\colorbox{celadon}{#1$_{\texttt{change\_trigger}}^{\textcolor{red}{increase}}$}}
% \newcommand{\triggerDec}[1]{\colorbox{celadon}{#1$_{\texttt{change\_trigger}}^{\textcolor{red}{decrease}}$}}
% \newcommand{\triggerUD}[1]{\colorbox{celadon}{#1$_{\texttt{change\_trigger}}^{\textcolor{red}{unique\_dose}}$}}
% \newcommand{\triggerStart}[1]{\colorbox{celadon}{#1$_{\texttt{change\_trigger}}^{\textcolor{red}{started}}$}}
% \newcommand{\triggerStop}[1]{\colorbox{celadon}{#1$_{\texttt{change\_trigger}}^{\textcolor{red}{stopped}}$}}
...
\examples{ex:caused}
    {(..) The pill does its job, by I constantly feel sick to my stomach and have absolutely no appetite. (..)}
...
\examples{ex:change}
    {}
    {depuis que j'ai arrêté deroxat pour effexor j'ai perdu 3 kilos sans rien foutre et en mangeant peut être mm +}
    {}
    {} 
